...
*** Variables ***
${old-ova-file-name}=  vic-v1.4.2-5659-4ee49390.ova
${old-ova-version}=  v1.4.2
...
*** Test Cases ***
Upgrade OVA 1.4.2
    Auto Upgrade OVA With Verification  7-04-UPGRADE-1-4-2  ${old-ova-file-name}  ${old-ova-version}  ${old-ova-cert-path}  ${new-ova-cert-path}  dc1
